  ...
  const init = async () => {
      ...
      try {
        ...
        usersSnap.forEach(doc => {
          ...
          // Use db status if it exists, otherwise proxy from isPaid
      ...
      <header className="bg-white border-b border-slate-200 px-6 sm:px-8 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">SaaS Admin Control Center</p>
          </div>
        </div>
        <button 
                      ...
                      filteredCompanies.map((c) => (
                        <tr key={c.uid} className="hover:bg-slate-50/50 transition-colors group">
                          ...
                          <td className="py-4 px-6">
                            ...
                            <div className="text-xs text-slate-400 mt-0.5 flex items-center gap-1"><Activity size={10}/> Active: {formatDate(c.updatedAt)}</div>
                          </td>
                 ...
                 <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                   <div>
                     ...
                     <div className="flex flex-wrap items-center gap-4 text-sm text-slate-300 font-medium">
                        ...
                        <span className="flex items-center gap-1.5 md:border-l border-slate-700 md:pl-4"><Clock size={16} className="text-slate-500"/> Joined: {formatDate(selectedCompany.createdAt)}</span>
                   ...
                   <div>
                     {selectedCompany.status === "Blocked" || selectedCompany.status === "Suspended" ? (
                        <span className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-red-500/20 text-red-300 text-sm font-bold border border-red-500/30">
                          <Ban size={18} /> {selectedCompany.status}
                        </span>
               ...
               <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                     <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 flex items-center gap-2">
                       <BadgeCheck size={14}/> Subscription Info
                     </h4>
                     <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 grid grid-cols-2 gap-6 relative overflow-hidden">
                        ...
                        <div className="pt-4 border-t border-slate-200 col-span-2">
...
console.log('Safe superadmin updates applied!');
