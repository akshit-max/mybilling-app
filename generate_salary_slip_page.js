...
const dirPath = "d:\\Billing-app\\billing-app\\src\\app\\dashboard\\staff\\[id]\\salary-slip";
...
export default function SalarySlipPrintView() {
  ...
  return (
    <div className="bg-white min-h-screen text-gray-900 font-sans p-8 print:p-0 max-w-[800px] mx-auto">
