...
export default function CreateCreditNote() {
  ...
  useEffect(() => {
    ...
    const user = auth.currentUser;
      ...
      try {
        ...
        const cnq = query(collection(db, "proformaInvoices"), where("userId", "==", user.uid));
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, "proformaInvoices"), data);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Create Proforma Invoice</h1>
        </div>
              ...
              {items.map((item, idx) => (
                <div key={idx} className="space-y-2">
                  <div className="grid grid-cols-12 gap-3 items-center">
                    ...
                    <div className="col-span-3 relative flex flex-col gap-1.5">
                    ...
                    <div className="col-span-2 flex items-center border border-gray-200 rounded overflow-hidden bg-white w-full">
                      <select
