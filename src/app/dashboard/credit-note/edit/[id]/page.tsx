...
export default function EditCreditNote() {
    ...
    const user = auth.currentUser;
      ...
      try {
        ...
        if (snap.exists()) {
          ...
          setCreditNoteNumber(loaded.creditNoteNumber || "");
  ...
  const handleUpdate = async () => {
    ...
    // Add stock skipped on edit for safety
      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-0.5">
            <h1 className="text-sm font-bold text-gray-800 uppercase tracking-wider">Update Credit Note</h1>
