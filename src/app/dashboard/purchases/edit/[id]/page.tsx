      ...
      <header className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-xs">
        <div className="flex items-center gap-4">
          ...
          <div className="space-y-0.5">
            <h1 className="text-sm font-bold text-gray-800 uppercase tracking-wider">UPDATE PURCHASE INVOICE</h1>
          ...
          <div className="p-4 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider">Purchase No.</label>
                <input
                  type="text"
              ...
              <div className="space-y-1.5">
                <label className="block text-[10px] font-bold text-gray-400 uppercase tracking-wider">Purchase Date</label>
                <input
                  type="date"
                  value={invoiceDate}
            ...
            <div className="pt-3 border-t border-gray-200/80 space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4 items-center pt-2">
                <div className="space-y-1">
                  ...
                  <input
                    type="text"
                    value={amountPaid}
                    onChange={(e) => setAmountPaid(sanitizeNumericInput(e.target.value))}
              ...
              <div className="flex justify-between items-center pt-1.5">
                <label className="flex items-center gap-1.5 text-[9px] font-bold text-gray-400 uppercase tracking-wider cursor-pointer">
                  <input 
                    type="checkbox" 
                    checked={Number(amountPaid).toFixed(2) === finalTotal.toFixed(2) && status === "paid"}
