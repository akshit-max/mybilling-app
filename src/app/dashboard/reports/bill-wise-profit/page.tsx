  ...
  const handleEmailExcel = async () => {
    ...
    const tableHTML = `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #1e3a8a;">Bill Wise Profit Report</h2>
        ...
        <table style="border-collapse: collapse; width: 100%; margin-top: 16px;">
          ...
          <tfoot>
            <tr style="font-weight: bold; background-color: #f9fafb;">
              ...
              <td style="border: 1px solid #e5e7eb; padding: 8px;">₹ ${totalCostAmount.toFixed(2)}</td>
              <td style="border: 1px solid #e5e7eb; padding: 8px;">₹ ${totalProfit.toFixed(2)}</td>
              <td style="border: 1px solid #e5e7eb; padding: 8px;">${avgMargin.toFixed(2)}%</td>
            </tr>
          </tfoot>
        </table>
      </div>
