...
export default function RateListReport() {
  const [items, setItems] = useState<ItemRate[]>([]);
  ...
  const handleExportExcel = () => {
    ...
    const headers = ["Item Name", "Item Code", "Category", "Sales Price", "Purchase Price", "GST (%)"];
  ...
  const handleEmailExcel = async () => {
    ...
    const tableHTML = `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #1e3a8a;">Rate List Report</h2>
    ...
    <div id="print-area" className="space-y-0 max-w-full mx-auto pb-10 font-sans bg-gray-50/50 min-h-screen print:bg-white print:pb-0">
      ...
      <div className="flex justify-between items-center bg-white px-6 py-3 border-b border-gray-200 shadow-sm print:hidden">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base font-bold text-gray-800">Rate List</h1>
          <button 
            onClick={() => {
      ...
      <div className="hidden print:block text-center py-6 border-b border-gray-200 mb-4">
        <h1 className="text-2xl font-bold text-gray-800 uppercase tracking-wider">Rate List</h1>
            ...
            <table className="w-full text-left text-xs border-collapse">
              <thead>
                <tr className="bg-gray-50/80 border-b border-gray-200 text-gray-500 font-semibold uppercase tracking-wider text-[10px] print:bg-gray-100">
                  ...
                  <th className="px-4 py-3 border-r border-gray-100 print:border-gray-300 text-right">Sales Price</th>
                  <th className="px-4 py-3 border-r border-gray-100 print:border-gray-300 text-right">Purchase Price</th>
                  <th className="px-4 py-3 text-center print:border-gray-300">GST %</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-100 print:divide-gray-200">
                {filteredItems.map((p) => (
                  <tr key={p.id} className="hover:bg-indigo-50/30 transition-colors group">
                    ...
                    <td className="px-4 py-3 font-mono font-semibold text-gray-800 text-right border-r border-gray-50 print:border-gray-300">
                      ₹ {p.salesPrice.toLocaleString('en-IN', { minimumFractionDigits: 0 })}
                    </td>
                    ...
                    <td className="px-4 py-3 font-mono font-semibold text-gray-600 text-center print:border-gray-300">
                      {p.gst}%
                    </td>
                  </tr>
                ))}
