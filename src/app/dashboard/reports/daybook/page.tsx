        ...
        invSnap.docs.forEach(doc => {
          ...
          if (d.status !== "cancelled" && d.invoiceType !== "estimate") {
            data.push({
              ...
              partyName: d.customerName || d.partyName || "Cash Sale",
              cashIn: Number(d.total || 0),
              cashOut: 0,
            });
          }
        });
  ...
  const handleEmailExcel = async () => {
    ...
    const tableHTML = `
      <div style="font-family: Arial, sans-serif; padding: 20px;">
        <h2 style="color: #1e3a8a;">Daybook Report</h2>
    ...
    await toast.promise(
      fetch("/api/send-email", {
        ...
        body: JSON.stringify({
          ...
          html: "<p>Please find the attached " + "Daybook Report" + " Excel report.</p>",
          attachments: [
            {
              filename: "Daybook Report".replace(/\s+/g, '_') + ".xls",
    ...
    <div id="print-area" className="space-y-0 max-w-full mx-auto pb-10 font-sans bg-gray-50/50 min-h-screen print:bg-white print:pb-0">
      ...
      <div className="flex justify-between items-center bg-white px-6 py-3 border-b border-gray-200 shadow-sm print:hidden">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-base font-bold text-gray-800">Daybook</h1>
          <button 
            onClick={() => {
      ...
      <div className="hidden print:block text-center py-6 border-b border-gray-200 mb-4">
        <h1 className="text-2xl font-bold text-gray-800 uppercase tracking-wider">Daybook Report</h1>
