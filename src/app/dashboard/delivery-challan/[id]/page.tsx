...
export default function ViewCreditNote() {
  ...
  const handleWhatsAppShare = () => {
    if (!deliveryChallan?.customerPhone) {
      toast.error("Customer phone number is missing");
      return;
    }
    const message = `Dear ${deliveryChallan.customerName},\n\nYour credit note *${deliveryChallan.deliveryChallanNumber || "N/A"}* has been generated successfully.\n\nTotal Amount: *₹${deliveryChallan.total.toFixed(2)}*\n\nThank you for choosing ${company?.name || "our company"}.`;
    const phone = deliveryChallan.customerPhone.replace(/\D/g, "");
