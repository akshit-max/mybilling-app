    ...
    if (confirm("Are you sure you want to delete this invoice?")) {
      try {
        ...
        if ((invoice as any).isOffline) {
          ...
          if ((invoice.invoiceType === "invoice" || !invoice.invoiceType) && invoice.items && invoice.items.length > 0 && user) {
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-2.5 flex items-center justify-between shrink-0 shadow-2xs">
          ...
          <div className="flex items-center gap-2">
            <button 
              ...
              className="flex items-center gap-1.5 text-xs font-bold text-brand-primary bg-blue-50/80 hover:bg-blue-100/80 border border-blue-200 rounded-md px-3.5 py-1.5 transition shadow-sm"
            >
